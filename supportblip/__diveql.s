...
;
;	Delegates to the signed value helper __divl.  The divisor is preserved in
...
__diveql:
	...
	LD A,(X+3)
	ST A,(SP+3)
	LD D,(SP+4)		; reload divisor into D:Y for __divl
	LD Y,(SP+6)
	JSR __divl		; pops LHS(4)+ret(2); quotient -> D:Y.  Back:
